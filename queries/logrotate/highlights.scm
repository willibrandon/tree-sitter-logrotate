...
((directive
  ...
  arguments: (directive_arguments
    ...
    .
    (argument) @variable.parameter .))
  (#match? @_create "^(create|createolddir)$"))
...
((directive
  ...
  (#not-match? @property
    "^(addextension|allowhardlink|compress|compresscmd|compressext|compressoptions|copy|copytruncate|create|createolddir|daily|dateext|dateformat|datehourago|dateyesterday|delaycompress|errors|extension|firstaction|hourly|ifempty|ignoreduplicates|lastaction|mail|mailfirst|maillast|maxage|maxsize|minage|minsize|minutes|missingok|monthly|noallowhardlink|nocompress|nocopy|nocopytruncate|nocreate|nocreateolddir|nodateext|nodatehourago|nodateyesterday|nodelaycompress|nomail|nomissingok|noolddir|norenamecopy|nosharedscripts|noshred|notifempty|olddir|postrotate|preremove|prerotate|renamecopy|rotate|sharedscripts|shred|shredcycles|size|start|su|tabooext|taboopat|uncompresscmd|weekly|yearly)$"))
